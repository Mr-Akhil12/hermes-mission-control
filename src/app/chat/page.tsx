...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-dvh overflow-hidden -mt-[2%] md:mt-0">
      ...
      {mobileShowSidebar && (
        <div className="fixed inset-0 z-40 md:hidden" onClick={() => setMobileShowSidebar(false)}>
          <div className="absolute inset-0 bg-black/50" />
          <div
            className="absolute left-0 top-0 bottom-0 w-[280px] bg-[var(--bg-secondary)] border-r border-[var(--border)] flex flex-col animate-slide-up"
      ...
      <div className="hidden md:flex w-[300px] h-full bg-[var(--bg-secondary)] md:bg-transparent border-r border-[var(--border)] flex-col flex-shrink-0">
        {/* Sidebar Header */}
        <div className="px-4 py-3 border-b border-[var(--border)] flex items-center justify-between flex-shrink-0">
          <h2 className="text-sm font-semibold gradient-text">Conversations</h2>
          <button
